...
//                Intent intentBulletinsList = new Intent();
...
//                startActivity(intentBulletinsList);
            ...
            case R.id.nav_camera:
                Toast.makeText(this, "Opção escolhida: nav_camera", Toast.LENGTH_LONG).show();
                break;

            case R.id.nav_gallery:
                Toast.makeText(this, "Opção escolhida: nav_gallery", Toast.LENGTH_LONG).show();
                break;

            case R.id.nav_slideshow:
                Toast.makeText(this, "Opção escolhida: nav_slideshow", Toast.LENGTH_LONG).show();
                break;

            case R.id.nav_manage:
                Toast.makeText(this, "Opção escolhida: nav_manage", Toast.LENGTH_LONG).show();
                break;

            case R.id.nav_share:
                Toast.makeText(this, "Opção escolhida: nav_share", Toast.LENGTH_LONG).show();
                break;
